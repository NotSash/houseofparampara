        ...
        <Reveal className="relative">
          <div className="relative aspect-[4/5] overflow-hidden rounded-3xl shadow-warm">
            <Image
              ...
              fill
              /*
               * Half-width from `md` up, full width below. Without `sizes`,
               * next/image assumes 100vw everywhere and serves a source twice
               * as wide as this ever renders on a desktop.
               */
        ...
        <div>
          ...
          <Reveal delay={0.05}>
            <h2 className="mt-5 text-balance font-serif text-3xl leading-tight text-foreground sm:text-4xl lg:text-5xl">
              Some bonds are <span className="italic text-primary-ink">timeless</span>
            </h2>
          </Reveal>
          <Reveal delay={0.1}>
