    ...
    <section id="contact" className="relative scroll-mt-24 overflow-hidden bg-[#5c2c20] py-20 text-[#fbf1e4] md:py-32 dark:bg-[#190f0b]">
      <div className="pointer-events-none absolute inset-0 opacity-[0.08] dark:opacity-[0.14]">
        <Image
          ...
          fill
          /*
           * `sizes` is required whenever `fill` is used, otherwise next/image
           * assumes the image spans the full viewport at every breakpoint and
           * serves an unnecessarily large source. This is a full-bleed
           * background, so 100vw is correct here, but it has to be stated.
           */
          sizes="100vw"
